"""openmv-ota — secure OTA update tooling for OpenMV cameras.
...
The authoritative design is ``docs/reference/architecture.md`` (and ``docs/reference/v2-plan.md`` for the
